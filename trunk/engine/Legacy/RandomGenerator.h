...
public:
  ...
  std::vector<int> sampleGroup(int size,int groupSize);
  ...
  void   SampleDirichlet(const std::vector<double>& rgalpha,
			 std::vector<double>& rgprob);
  
  
  void   SampleDirichlet(const std::vector<double>& mean,
			 double precision,
			 std::vector<double>& rgprob );
...
inline
void
tRandomGenerator::SampleDirichlet(const std::vector<double>& rgalpha,
				  std::vector<double>& rgprob)
{
